...
namespace NavKeypad
{
    public class Keypad : MonoBehaviour
    {
        ...
        public void OpenDoorWithKeypad(Transform doorTransform)
        {
            var firstRot = doorTransform.transform.localEulerAngles;
            AudioManager.Instance.PlayOneShot("Door_Opening");
            doorTransform.transform.DOLocalRotate(new Vector3(0, 200, 0), 3f)
                .OnComplete(() =>
                {
                    DOVirtual.DelayedCall(10f, (() => AudioManager.Instance.PlayOneShot("Door_Closing")));
                    doorTransform.transform.DOLocalRotate(firstRot, 2f).SetDelay(10f);
                });
        }
    }
}